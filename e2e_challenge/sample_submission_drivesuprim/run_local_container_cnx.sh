  ...
  args=(
    ...
    --rm
    --init
    --name drivesuprim-v2-cnx-deploy
    ...
    ## DriveSuprim v2_cnx_deploy
    -e "DRIVESUPRIM_BACKBONE_TYPE=bevformer_m"
    -e "DRIVESUPRIM_BEV_VARIANT=v2_cnx_deploy"
    -e "DRIVESUPRIM_CHECKPOINT_PATH=/app/assets/drivesuprim/drivesuprim_v2_cnx_deploy_random.ckpt"
    -e "DRIVESUPRIM_BACKBONE_PATH="
