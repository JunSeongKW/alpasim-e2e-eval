#!/usr/bin/env python3
"""Compose the NuRec stage-3 (ViT-S + BEVFormer) config for challenge deployment."""
...
CONFIG_NAME = "drivesuprim_agent_bevformer_vov_v2_vits_stage3_nurec"
...
def main() -> int:
    ...
    print(f"Wrote NuRec stage-3 deployment config: {args.output}")
    return 0
