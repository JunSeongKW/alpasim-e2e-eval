...
class MetricCache:
    ...
    # themselves.  ``road_edge_elevations`` carries one height per line, used to
    # drop a flyover's edge passing above the road the ego is on.  Both stay
    # optional: NAVSIM caches have no boundaries and keep the nuPlan rule.
