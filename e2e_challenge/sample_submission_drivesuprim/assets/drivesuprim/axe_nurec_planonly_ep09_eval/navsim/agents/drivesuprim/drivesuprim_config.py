...
class DriveSuprimConfig(TransfuserConfig):
    ...
    # Divide the imitation softmax by its own max before it is weighted. The
    # peak swings between 0.16 and 0.99 from frame to frame, so without this
    # the same weight means something different every frame; with it the weight
    # is a fixed fraction of the term's own range.
