...
# Vendored from NVIDIA's alpasim_controller (Apache-2.0), unmodified except
# for what Python 3.9 requires and for the geometry import. Kept as the
# reference the batched port is checked against -- do not "improve" it.
"""
...
import numpy as np
from navsim.planning.simulation.planner.nurec_controller.geometry import Trajectory
...
class MPCImplementation(str, Enum):
